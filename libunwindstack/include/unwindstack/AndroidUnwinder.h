...
class AndroidUnwinder {
 public:
  ...
  // If use_global_elf_cache is false, even if the global elf cache has been
  ...
  void set_use_global_elf_cache(bool use) { use_global_elf_cache_ = use; }
 ...
 protected:
  ...
  bool use_global_elf_cache_ = false;
